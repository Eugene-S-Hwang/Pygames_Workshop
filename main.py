## Credits for code to Hack Club
## https://hackclub.notion.site/counterspell-pygame
...
def game_over_display():
    ...
    game_over_txt = font.render("Game Over", True, WHITE) #string, antialias (smooth graphics for letters), color
...
def generate_platforms():
    ...
    while current_platform_count < num_platforms:
        platform_x = (random.randint(0,
                                     SCREEN_WIDTH - platform_width))  # random.randint(a,b) generate a random integer between a and b
        platform_y = (random.randint(80 + (current_platform_count * (SCREEN_HEIGHT - 80) // num_platforms),
                                     (80 + (current_platform_count + 1) * (SCREEN_HEIGHT - 80) // num_platforms)))
